                    ...
                    ">
                        ...
                        <div>
                            ...
                            <p class="
                                ...
                                mt-1
                            ">
                                Escolha quais professores terão acesso a esta sala.
                            </p>
                        </div>
                        ...
                        @if ($teachers->count())
                            <span class="badge badge-ghost">
                                {{ $teachers->count() }}
                                {{ $teachers->count() === 1 ? 'professor' : 'professores' }}
                            </span>
                        @endif
                        ...
                        @forelse ($teachers as $teacher)
                            ...
                            @php
                                $isSelected = in_array(
                                    ...
                                    old(
                                        'teachers',
                                        $classroom->teachers->pluck('id')->toArray()
                                    )
                                );
                            @endphp
                        ...
                        @empty
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="alert alert-warning">
                                    ...
                                    <span>
                                        Nenhum professor disponível para atribuição.
                                    </span>
