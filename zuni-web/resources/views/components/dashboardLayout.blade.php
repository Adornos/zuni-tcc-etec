...
<div class="flex flex-col h-full">
    ...
    {{-- Header --}}
    <header class="flex items-end justify-between px-6 py-4 border-b bg-base-100">
    ...
    <main class="flex-1 p-6 bg-base-200">
        ...
        <aside class="w-[260px] h-screen bg-primary text-primary-content flex flex-col">

            {{-- Logo --}}
            <div class="flex justify-center py-8">
                <img
                    src="{{ asset('assets/logo_white.svg') }}"
                    alt="Logo"
                    class="h-14"
                >
            </div>
            ...
            <div class="flex-1 px-3">
                ...
                <ul class="menu w-full gap-1">
                    ...
                    <li>
                        <a href=""
                        class="{{ request()->routeIs('studentRegister') ? 'active' : '' }}">
