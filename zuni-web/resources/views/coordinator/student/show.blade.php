                    ...
                    <div class="flex flex-row gap-[1.5vmax] md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex-col items-center">
                            ...
                            <div class="min-w-0 p-[1vmax] flex flex-row">
                                @if($studentSheet->user->photo ?? false)
                                ...
                                <div class="
                                    ...
                                    h-[10vmax]">
                                    <img
                                        src="{{ asset('storage/' . $studentSheet->user->photo) }}"
                                        alt="Foto de {{ $studentSheet->user->name }}"
                                ...
                                ">
                                    ...
                                    <span class="text-base-content/60">
                                        ...
                                        <strong class="text-base-content">
                                            {{ \Carbon\Carbon::parse($studentSheet->birth_date)->format('d/m/Y') }}
                                        </strong>
                                    </span>
                        ...
                        ">
                            ...
                            <span class="
                                ...
                                {{ match($studentSheet->user->status->value) {
                            ...
                            ">
                                ...
                                {{ $studentSheet->user->status->label()}}
                            ...
                            <span class="text-[.85vmax] text-base-content/60">
                                ...
                                <strong class="text-base-content">
                                    {{ str_pad($studentSheet->id, 4, '0', STR_PAD_LEFT) }}
                                </strong>
            ...
            ">
                ...
                <div class="card-body p-[1.5vmax]">
                    ...
                    ">
                        ...
                        <form action="{{ route('coordinator.enrollment.approve', ['enrollment' => $studentSheet->enrollment ]) }}" method="POST">
                            @csrf
                            @method('PUT')
                        ...
                        <form action="{{ route('coordinator.enrollment.reject', ['enrollment' => $studentSheet->enrollment ]) }}" method="POST">
                            @csrf
                            @method('PUT')
                    ...
                    ">
                        ...
                        <div class="flex items-center gap-[1vmax] min-w-0">
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="text-[.9vmax] font-semibold">
                                    {{ $studentSheet->guardian->name ?? 'Default Guardian' }}
                                </p>
                ...
                <div class="card-body p-[1.5vmax]">
                    ...
                    ">
                        ...
                        <div>
                            ...
                            <p class="text-[.9vmax] mt-[.2vmax]">
                                {{ $studentSheet->food_restriction ?: 'Não informado' }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-[.9vmax] mt-[.2vmax]">
                                {{ $studentSheet->special_care ?: 'Não informado' }}
                            </p>
                        </div>
