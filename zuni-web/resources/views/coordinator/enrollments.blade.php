<!-- row-span-4 col-span-4 card 100% -->
 <!-- cada card deve ser clicável e quando for clicado, deve redirecionar para a página de matrículas da respectiva sala -->
  <!-- cada ano tem a turma A ou B ou C ou D, na qual, são turmas com alunos diferentes, vc muda clicando na setinha que deve estar ao lado do ano com a série, assim: 3°ANO C ->  -->
<div class="card bg-base-100 shadow-md 
row-span-4 col-span-4 flex-col p-[1vmax] bg-Ccard overflow-y-auto">
